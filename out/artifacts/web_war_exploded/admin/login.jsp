...
<div class="page-container">
    <header class="header">
        <h1 onclick="location.href='${contextPath}/application/admin';">Online Take-Away System<br>Admin</h1>
    </header>

    <div class="box">
        <h4>To continue, please login</h4>
        <hr>
        <form method="POST" action="${contextPath}/application/admin/login" name="myform">
